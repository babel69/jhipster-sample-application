...
import fr.it_akademy.charbel.service.CountryService;
...
/**
 * Service Implementation for managing {@link fr.it_akademy.charbel.domain.Country}.
 */
@Service
@Transactional
public class CountryServiceImpl implements CountryService {
    ...
    /**
     *  Get all the countries where Character is {@code null}.
     *  @return the list of entities.
     */
    @Transactional(readOnly = true)
    public List<CountryDTO> findAllWhereCharacterIsNull() {
        log.debug("Request to get all countries where Character is null");
        return StreamSupport
            .stream(countryRepository.findAll().spliterator(), false)
            .filter(country -> country.getCharacter() == null)
            .map(countryMapper::toDto)
