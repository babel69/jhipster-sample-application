...
/**
 * REST controller for managing {@link fr.it_akademy.charbel.domain.Country}.
 */
@RestController
...
public class CountryResource {
    ...
    public List<CountryDTO> getAllCountries(@RequestParam(required = false) String filter) {
        if ("character-is-null".equals(filter)) {
            log.debug("REST request to get all Countrys where character is null");
            return countryService.findAllWhereCharacterIsNull();
        }
