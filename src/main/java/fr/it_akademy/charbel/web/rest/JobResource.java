...
/**
 * REST controller for managing {@link fr.it_akademy.charbel.domain.Job}.
 */
@RestController
...
public class JobResource {
    ...
    public List<JobDTO> getAllJobs(@RequestParam(required = false) String filter) {
        if ("character-is-null".equals(filter)) {
            log.debug("REST request to get all Jobs where character is null");
            return jobService.findAllWhereCharacterIsNull();
        }
