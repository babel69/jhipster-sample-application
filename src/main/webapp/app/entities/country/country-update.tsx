...
export const CountryUpdate = () => {
  ...
  const saveEntity = values => {
    ...
    if (values.countryNumber !== undefined && typeof values.countryNumber !== 'number') {
      values.countryNumber = Number(values.countryNumber);
    }
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.country.name')}
                id="country-name"
                name="name"
                data-cy="name"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.country.countryNumber')}
                id="country-countryNumber"
                name="countryNumber"
                data-cy="countryNumber"
                type="text"
              />
