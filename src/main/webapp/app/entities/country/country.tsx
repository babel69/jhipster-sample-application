            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.country.name">Name</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('name')} />
                </th>
                <th className="hand" onClick={sort('countryNumber')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.country.countryNumber">Country Number</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('countryNumber')} />
                </th>
                <th />
              </tr>
            </thead>
