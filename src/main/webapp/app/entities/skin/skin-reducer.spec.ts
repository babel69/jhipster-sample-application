...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './skin.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SKIN_LIST actions', async () => {
    ...
    it('dispatches FETCH_SKIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SKIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SKIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SKIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SKIN actions', async () => {
      const expectedActions = [
        {
